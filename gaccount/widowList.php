...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <h3 class="header mt-4">Widow people list</h3>

        <!-- widow people list table start -->
        <div class="row my-5">
            <table class="table table-striped table-responsive-md table-bordered my-5" id="widowTable">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php
                        ...
                        $sql = "SELECT * FROM `personal_details` WHERE status='වැන්දඹු'";
                           ...
                           while($data = mysqli_fetch_assoc($result)){
                            ...
                            echo'
                                <tr>
                                    ...
                                    <td class="sinhala-font">'.$data["spouse"].'</td>
        ...
        </div>  <!-- widow people list table end -->
