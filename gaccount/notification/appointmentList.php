...
<div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="table-name">
                    <h3 class="table-name-header m-5"><u>Appointment List</u></h3>
            </div>
            ...
            <div class="row my-5">
                <table class="table table-striped table-responsive-md table-bordered my-5" id="appointmentList">
                    <thead>
                        <tr>
                            ...
                            <th class="sinhala-font">අනුමැතිය</th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <?php
                        ...
                        $appointmentIdSql = "SELECT id FROM appointment WHERE acceptance='pending'";
                        $result= mysqli_query($conn, $appointmentIdSql);
                        ...
                        if(mysqli_num_rows($result)>0){
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                //select user data
                                $selectUserData = "SELECT user.first_name, user.last_name, user.nic, user.email, appointment.phone, appointment.category, appointment.text, appointment.date_time FROM `user`,`appointment` WHERE appointment.user_id = user.u_id AND appointment.id = '".$appointmentId."'";
                                ...
                                <tr class="'.$appointmentId.'" id="'.$appointmentId.'">
                                    ...
                                    <td class="sinhala-font" name="change" id="change">
                                        <div class="btn-group">
                                            <button class="btn btn-success mr-1" name="accept" id="'.$appointmentId.'" onclick="aprove(this)" data-bs-toggle="tooltip" data-bs-placement="top" title="ACCEPT"><i class="bi bi-check-lg"></i></button>
                                            <button class="btn btn-danger" name="reject" id="'.$appointmentId.'" onclick="reject(this)" data-bs-toggle="tooltip" data-bs-placement="top" title="REJECT"><i class="bi bi-x-lg"></i></button>
                                        </div>
                                    </td>
                                </tr>
                                ';
