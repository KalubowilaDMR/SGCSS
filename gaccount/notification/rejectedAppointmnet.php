...
<div class="wrapper">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="notification">
                        ...
                        <li>
                            <a href="">Rejected Appointment List</a>
                        </li>
                        <li>
        ...
        <div id="content">
            ...
            <div class="table-name">
                    <h3 class="table-name-header m-5"><u>Rejected Appointment</u></h3>
            </div>
            ...
            <div class="row my-5">
                <table class="table table-striped table-responsive-md table-bordered my-5" id="rejectApList">
                    <thead>
                        <tr>
                    ...
                    <?php
                        ...
                        $appointmentId = "SELECT id FROM appointment WHERE acceptance='rejected'";
                        ...
                        if(mysqli_num_rows($result)>0){
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                //select user data
                                $selectUserData = "SELECT user.first_name, user.last_name, user.nic, user.email, appointment.phone, appointment.category, appointment.text, appointment.date_time FROM `user`,`appointment` WHERE appointment.user_id = user.u_id AND appointment.acceptance='rejected' AND appointment.id='".$appointmentId."'";
