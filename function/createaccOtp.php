<?php
    ...
    if($_SESSION['regOtp'] || $_SESSION['regEmail']){
...
<body>
    ...
    $mail = new PHPMailer(true);
        ...
        if(isset($_SESSION['regOtp'])){

            $regOtp =  $_SESSION['regOtp'];
        ...
        try {
            ...
            //Recipients
            $mail->setFrom('sgcss.pinnawala.north@gmail.com', 'Activate Account');
            ...
            $mail->Body    = 'This is your OTP code for verify new account. <b>'.$regOtp.'</b>';
